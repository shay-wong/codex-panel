...
- 代码及验证：`src-tauri/src/main.rs`、`src-tauri/build.rs`、`src-tauri/Cargo.toml`、`src-tauri/ui/index.html`、`scripts/create-macos-updater.mjs`、`scripts/release-metadata.mjs`、`scripts/verify-updater-signature.mjs`；`test/launcher-ui.test.mjs`、`test/release-metadata.test.mjs`、`test/updater-signature.test.mjs` 及 Rust updater 定向测试。
