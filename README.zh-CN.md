...
针对 ChatGPT 桌面版 26.917.51856，Panel 还会适配本地 Codex 输入框，避免登录账号额度耗尽时错误禁用自定义模型服务的发送入口，保留现有登录和服务凭据。兼容范围与验证限制见[自定义服务发送](docs/fork-capabilities.md#custom-provider-send-availability)。
