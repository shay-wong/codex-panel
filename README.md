...
Continue planning recognizes the active native conversation even when the window URL remains unchanged. During manual execution, the detail action follows the board's conversation activity and opens the existing conversation.
