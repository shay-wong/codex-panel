...
export function resolvePanelUrl(path: string): string {
...
export function subscribeAiChatThread(
  ...
  const source = new EventSource(
    resolvePanelUrl(`/api/local/ai/threads/${encodeURIComponent(threadId)}/events`),
  );
