...
$app = $env:CODEX_PANEL_CODEX_APP_PATH
...
$app = $env:CODEX_PANEL_CODEX_APP_PATH
$profile = $env:CODEX_PANEL_CODEX_PROFILE
$port = $env:CODEX_PANEL_CODEX_PORT
...
export function windowsCodexProcesses(appPath, environment, run = spawnSync) {
  const output = runWindowsPowerShell(
    ...
    { ...environment, CODEX_PANEL_CODEX_APP_PATH: appPath },
    run,
  );
  if (!output) return [];
...
export function activateWindowsCodex(appPath, profilePath, port, environment, run = spawnSync) {
  const output = runWindowsPowerShell(
    ...
    {
      ...environment,
      CODEX_PANEL_CODEX_APP_PATH: appPath,
      CODEX_PANEL_CODEX_PROFILE: profilePath,
      CODEX_PANEL_CODEX_PORT: String(port),
    },
    run,
  );
